...
export const Text = styled.p<TextProps>`
  ...
  ${({ size = FONT_SIZE_BASE }) =>
    size &&
    buildResponsiveRules<number>('font-size', size, convertPixelsToRems)}
  ${({ weight = '400' }) =>
  ...
  ${({ hoverColor }) =>
    ...
    `}
  ${({ opacity }) =>
    opacity && buildResponsiveRules<number>('opacity', opacity)}
...
export const Headline2 = styled(Text).attrs((props) => ({
  as: 'h2',
  size: [32, { sm: 40, lg: 48 }],
  weight: '900',
...
export const Headline5 = styled(Text).attrs((props) => ({
  as: 'h5',
  size: [14, { md: 18, lg: 20 }],
  weight: '900',
...
export const BodyParagraph = styled(Text).attrs((props) => ({
  as: 'p',
  size: [16, { lg: 20 }],
...
export const BodyParagraph2 = styled(Text).attrs((props) => ({
  as: 'p',
  size: [14, { lg: 16 }],
